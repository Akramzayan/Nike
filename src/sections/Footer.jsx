  ...
  <footer className="max-container">
    ...
    flex-wrap max-lg:flex-col">
      <div className="flex flex-col items-start">
        ...
        text-white-400 sm:max-w-sm'>Get shoes ready for the new term at your nearest Nike Store. Find your perfect Size In Store.
        Get Rewards</p>
      ...
      {footerLinks.map((section)=> (
        ...
        <ul>
          {section.links.map((link)=>(
            <li className="mt-3
            text-white-400 font-montserrat text-base leading-normal
